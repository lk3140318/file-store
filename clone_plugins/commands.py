...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔥 𝗔𝗻𝗶𝗺𝗲 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 🎌', url='https://t.me/+fIVDHK4L6ik2NDY9')
            ],[
            InlineKeyboardButton('🎬 𝗠𝗼𝘃𝗶𝗲 & 𝗪𝗲𝗯 𝗦𝗲𝗿𝗶𝗲𝘀 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 🍿', url='https://t.me/+aKYv_zWN0nk0OWFl')
            ],[
    ...
    if not files_:
        ...
        try:
            ...
            title = '@Miss_Quinn_Bots  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
            ...
            k = await msg.reply(f"<b><u>❗️❗️❗️IMPORTANT❗️️❗️❗️</u></b>\n\nThis Movie File/Video will be deleted in <b><u>{AUTO_DELETE} mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this File/Video to your Saved Messages and Start Download there you want again [Get Here](https://t.me/Miss_Quinn_Bots) </i></b>",quote=True)
